                    ...
                    for i,a in enumerate(attributes):
                        ...
                        try:
                            if temp[1] == "static":
                                ...
                                a= temp[0] + " " + temp[3] + " " + temp[1]
                        except:
                            self.printMessage("Error with var length")
                        attributes[i] = a
                else:
                    attributes = []
            except:
            ...
            try:
                ...
                if len(methodLabelArray) == 1:
                    ...
                    for i, a in enumerate(methods):
                        ...
                        try:
                            if temp[1] == "static":
                                a = temp[0] + " " + temp[1] +" "+ temp[4] +" " + temp[2] + " " + temp[3]
                            else:
                                a = temp[0] + " " + temp[3] + " " + temp[1] + temp[2]
                            ...
                            for cntr, attribute in enumerate(attributesInMethod):
                                temp = re.split(" ", attribute)
                                if cntr == 0:
                                    fullattributes = temp[1] + " " + temp[0]
                                else:
                                    fullattributes += ", " + temp[1] + " " + temp[0]

                            a = re.sub("(?<=\()[^\)]*", fullattributes, a)
                        except:
                            self.printMessage("Error with method length")
                        methods[i] = a
