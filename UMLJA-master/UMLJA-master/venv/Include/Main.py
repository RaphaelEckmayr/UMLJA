...
class DnDPanel(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        self.lblname = wx.StaticText(self.panel, label="Project name:")
        self.editname = wx.TextCtrl(self.panel, size=(230, -1))
        self.projectPathLabel = wx.StaticText(self.panel, label="Project path:")
    ...
    def openFileChooser(self, event):
        ...
        with wx.FileDialog(self, "Open .graphml file",
                           style=wx.FD_OPEN | wx.FD_FILE_MUST_EXIST, defaultFile="*.graphml", wildcard="*.graphml") as fileDialog:
